...
ACC_FACTOR=5
ACC='5x'
EXP_DIR='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/12-channels/scratch/acc_5x/0_1'
CHECKPOINT='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/12-channels/scratch/acc_5x/0_1/model.pt'
...
EXP_DIR='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/12-channels/finetune/acc_'${ACC}'/'${LAYER_INIT}'_layer/'${LR}'/nodc/'${SAMPLE_RATE}
CHECKPOINT='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/12-channels/finetune/acc_'${ACC}'/'${LAYER_INIT}'_layer/'${LR}'/nodc/'${SAMPLE_RATE}'/model.pt'
