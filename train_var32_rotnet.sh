...
ACC_FACTOR=5
ACC='5x'
EXP_DIR='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/32-channels/pretext/rotnet/acc_'${ACC}
CHECKPOINT='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet/32-channels/pretext/rotnet/acc_'${ACC}'/vs_model.pt'
