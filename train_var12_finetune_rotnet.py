...
def main(args):
    ...
    print(" ROTATION PRETEXT MODEL loaded from = ",args.pretext_model)
    print()
    print("FINETUNING  of Model_Unet with 12-channels GT data wirh ROTATTION as PRETEXT, using",args.loss ,"@ LR=",args.lr)
