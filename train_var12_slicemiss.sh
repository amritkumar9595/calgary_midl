...
NUM_EPOCHS=150
DEVICE='cuda:0'
SAMPLE_RATE=5   # NO. OF SLICES = 5,10,20,40,47
CASCADE=12
...
ACC_FACTOR=5
ACC='5x'
PRETEXT_MODEL='/media/student1/NewVolume/MR_Reconstruction/experiments/midl/varnet_unet/12-channels/slicemiss/pretext/acc_5x/best_model.pt'
