"""
Pretext train VarNet from scratch with 12 channels data
...
from data.data_loader2 import SliceData , DataTransform_slicemiss
...
def main(args):
    ...
    if args.resume == 'True':
        ...
        optimizer = build_optim(list(model.parameters()) ,args.lr,args.weight_decay)
